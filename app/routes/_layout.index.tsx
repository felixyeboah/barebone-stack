...
export async function loader() {
	...
	const repoResponse = await fetch(
		'http://api.github.com/repos/dev-xo/barebones-stack',
		{
			headers: {
	...
	const repoStars = repoResponseToJson.stargazers_count || 98
		...
		<main className="mt-16 flex flex-col items-center justify-center">
			...
			<div className="relative flex flex-col items-center">
				...
				<img
					...
					alt=""
					className="float absolute top-[5%] left-[15%] h-16 w-28 select-none opacity-60 grayscale hue-rotate-180 invert transition
					hover:scale-110 hover:opacity-100 hover:grayscale-0"
				/>
				<img
					src="https://user-images.githubusercontent.com/1500684/157764484-ad64a21a-d7fb-47e3-8669-ec046da20c1f.svg"
					alt=""
					className="float absolute top-[25%] left-[5%] h-16 w-28 select-none opacity-80 grayscale hue-rotate-180 invert transition
					hover:scale-110 hover:opacity-100 hover:grayscale-0"
				/>
				...
				<img
					...
					alt=""
					className="float absolute top-[5%] right-[15%] h-16 w-32 select-none opacity-80 grayscale hue-rotate-180 invert transition
					hover:scale-110 hover:opacity-100 hover:grayscale-0"
				/>
				<img
					src="https://user-images.githubusercontent.com/1500684/157773063-20a0ed64-b9f8-4e0b-9d1e-0b65a3d4a6db.svg"
					alt=""
					className="float absolute top-[25%] right-[5%] h-14 w-14 select-none opacity-80 grayscale hue-rotate-180 invert transition
					hover:scale-110 hover:opacity-100 hover:grayscale-0"
				/>

				{/* Logo. */}
				<img
					src="https://raw.githubusercontent.com/dev-xo/dev-xo/main/assets/images/bone.png"
					alt=""
					className="pulse h-32 w-32 cursor-pointer select-none hue-rotate-15 transition hover:brightness-125"
				/>
				<div className="mb-8" />
				...
				<div className="flex cursor-default flex-col items-center">
					<h1 className="text-center text-8xl font-bold text-gray-100">
						...
						<span
							className="bg-gradient-to-b from-gray-200 to-gray-300 bg-clip-text text-8xl 
				...
				<p className="max-w-xl text-center text-2xl font-semibold text-gray-400">
					Easily manage{' '}
					<a
					...
					in a simple and clean testing-ready template.
				</p>
				<div className="mb-8" />
			...
			<div className="relative flex flex-col items-center justify-center">
				...
				<p className="max-w-2xl text-center text-2xl font-semibold text-gray-400">
					Barebones Stack is open source and powered by open source software. The
